...
class SubjectGaitFSMController:
    ...
    def start_walk_phase(self, natural_speed):
        ...
        self.target_speed = float(np.clip(desired_speed, 1.00 * natural_speed, 1.30 * natural_speed))
    ...
    def get_action(self, obs):
        ...
        leg_boost = float(np.clip(1.0 + 0.20 * max(desired_speed - self.forward_speed_ema, 0.0), 0.97, 1.20))
